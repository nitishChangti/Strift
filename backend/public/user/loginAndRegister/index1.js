...
//     storedMobileNumber = sessionStorage.getItem('mobileNumber');

//     //hiding a login section2 if it is true  and  showing a otp_verify
...
//     // if it is true  this verification_Code_sent shows a popup notification otp is sended to a user
//     if (event.type == 'submit') {
//         Verification_code_sent.style.display = 'flex'
//     }
//     document.querySelector('.Verification_code_sent span~ h1').innerHTML = `Verification code sent to ${mobileNumber}`
//     // document.querySelector('.verification_code_sent span h1').style.color = 'white'
//     // Verification_code_sent.innerHTML = `Verification code sent to ${mobileNumber}`
//     // it just shows  a popup notification otp is sended to a user for 3sec it shows after 3sec it hides
//     setTimeout(() => {
//         Verification_code_sent.style.display = 'none'
//     }, 3000)

//     document.querySelector('.otp_verify .otp_section_1 h1 span').innerHTML = mobileNumber
//     event.preventDefault();
...
//                     alert(' user  does not has an account with this mobile Number')
