...
<<<<<<< HEAD
  ...
  const mobileRegex = /^[6-9]\d{9}$/; // Must start with 6-9 and have exactly 10 digits
...
<<<<<<< HEAD
        console.log('exists')
        document.querySelector('.Number_sec ~ form').mobileNumber.value = data.data.user.phone
=======
